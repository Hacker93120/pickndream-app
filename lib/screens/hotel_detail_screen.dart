...
class _HotelDetailScreenState extends State<HotelDetailScreen> {
  ...
  Future<void> _bookHotel() async {
    ...
    // Vérifier l'abonnement (optionnel - vous pouvez supprimer cette vérification)
    if (provider.currentSubscription?.isActive != true) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Vous devez avoir un abonnement actif pour réserver'),
