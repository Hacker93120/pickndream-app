...
class PaymentScreen extends StatefulWidget {
  ...
  const PaymentScreen({Key? key, required this.subscription}) : super(key: key);
  ...
  Widget _buildPayPalButton() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.account_balance, size: 48, color: Colors.blue.shade600),
          SizedBox(height: 12),
          Text(
            'Payer avec PayPal',
            style: TextStyle(
        ...
        child: _isProcessing
            ...
            : Row(
                ...
                children: [
                  ...
                  SizedBox(width: 10),
                  Text(
                    'PAYER ${widget.subscription.price.toStringAsFixed(2)}€',
                    style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.bold,
                      color: Colors.white,
